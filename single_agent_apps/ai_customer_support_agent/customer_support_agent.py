...
A Streamlit-based customer support chatbot that uses OpenAI GPT-4 and Mem0 
for persistent memory storage. The agent can generate synthetic customer data,
maintain conversation history, and provide personalized support.
...
if openai_api_key:
    ...
    class CustomerSupportAIAgent:
        """
        AI Customer Support Agent with Memory Capabilities
        
        This class implements a customer support chatbot that:
        - Uses OpenAI GPT-4 for intelligent responses
        - Maintains persistent memory using Mem0 and Qdrant
        - Generates synthetic customer data for testing
        - Provides personalized support based on customer history
        """
        
        def __init__(self):
            """Initialize the AI agent with memory and OpenAI client."""
        ...
        def handle_query(self, query, user_id=None):
            """
            Process customer query and generate response with memory context.
            
            Args:
                query (str): Customer's question or request
                user_id (str): Unique customer identifier
                
            Returns:
                str: AI-generated response to the customer query
            """
            try:
        ...
        def get_memories(self, user_id=None):
            """
            Retrieve all stored memories for a specific customer.
            
            Args:
                user_id (str): Customer identifier
                
            Returns:
                dict: All stored memories for the customer
            """
            try:
        ...
        def generate_synthetic_data(self, user_id: str) -> dict | None:
            """
            Generate realistic customer profile and order history for testing.
            
            This method creates synthetic customer data including:
            - Customer personal information
            - Order history with realistic products and dates
            - Previous customer service interactions
            - Shopping preferences and patterns
            
            Args:
                user_id (str): Customer identifier for the synthetic profile
                
            Returns:
                dict | None: Generated customer data or None if generation fails
            """
            try:
                today = datetime.now()
